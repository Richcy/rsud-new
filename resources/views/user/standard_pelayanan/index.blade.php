...
@section('seo_keyword', 'standard Pelayanan Rumah Sakit, rumah sakit umum daerah cimacan, rsud cimacan, rsd cimacan')
@section('seo_title', 'RSUD Cimacan | Standard Pelayanan')
@section('seo_desc',
    'standard Pelayanan Rumah Sakit Daerah Cimacan')
