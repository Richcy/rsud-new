...
<div class="container my-5">
    <div class="row">
        <div class="col-12">
            <span><small><a href="">Beranda</a> / <a href="">Tentang</a> / <strong>Penilaian Mutu</strong></small></span>
            <div class="text-left">
                <h3>PENILAIAN MUTU RSUD CIMACAN</h3>
            </div>
            <div class="text-center">
                <img style="width: 75%; height: auto; display: block; margin: auto;" src="{{ asset('storage/'. $quality->img) }}" alt="">
            </div>
        </div>
