...
@section('seo_keyword', 'Farmasi, farmasi, Obat-obatan, rumah sakit, rumah sakit umum daerah cimacan, rsud cimacan, rsd cimacan')
@section('seo_title', 'RSUD Cimacan | Farmasi')
@section('seo_desc',
    'farmasi...')
...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <span><small><a href="">Beranda</a> / <a href="">Services</a> / <strong>Farmasi</strong></small></span>
                <div class="text-center">
                    <img style="height: 250px; width: 100%; object-fit:cover;" src="{{ asset('storage/'. $farmasi->banner) }}" alt="">
                </div>
            </div>
