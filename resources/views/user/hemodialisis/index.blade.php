...
@section('seo_keyword', 'Hemodialisis, rumah sakit, rumah sakit umum daerah cimacan, rsud cimacan, rsd cimacan')
@section('seo_title', 'RSUD Cimacan | Hemodialisis')
@section('seo_desc',
    'Hemodialisis...')
@section('seo_url', route('user.hemodialisis.index'))
...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <span><small><a href="">Beranda</a> / <a href="">Services</a> / <strong>Hemodialisis</strong></small></span>
                <div class="text-center">
                    <img style="height: 250px; width: 100%; object-fit:cover;" src="{{ asset('storage/'. $hemodilisis->banner) }}" alt="">
                </div>
            </div>
                    ...
                    <div class="{{ $image->isNotEmpty() ? 'col-12 col-md-6 col-lg-8' : 'col-12' }}">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse{{ $loop->index }}" class="accordion-collapse collapse" aria-hemodilisiselledby="heading{{ $loop->index }}" data-bs-parent="#accordionExample">
