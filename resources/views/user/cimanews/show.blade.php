@section('seo_keyword', $cimanews->title, 'rumah sakit umum daerah cimacan, rsud cimacan')
@section('seo_title', 'RSUD Cimacan | Dokter')
@section('seo_desc', $cimanews->sub_desc ? $cimanews->sub_desc : 'Detail Artikle', $cimanews->title)
