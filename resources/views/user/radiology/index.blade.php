...
@section('seo_keyword', 'Radiolog Rumah Sakit, rumah sakit umum daerah cimacan, rsud cimacan, rsd cimacan')
@section('seo_title', 'RSUD Cimacan | Radiologi')
@section('seo_desc',
    'Layanan radiologi merupakan unit penunjang yang ada di RSD Cimacan yang dapat memberikan pelayana pemeriksaan secara profesional dengan hasil beru...')
@section('seo_url', route('user.radiology.index'))
...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <span><small><a href="">Beranda</a> / <a href="">Services</a> / <strong>Radiologi</strong></small></span>
                <div class="text-center">
                    <img style="height: 250px; width: 100%; object-fit:cover;" src="{{ asset('storage/'. $radiology->banner) }}" alt="">
                </div>
            </div>
