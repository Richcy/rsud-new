@section('seo_keyword', $article->title, 'rumah sakit umum daerah cimacan, rsud cimacan')
@section('seo_title', 'RSUD Cimacan | Dokter')
@section('seo_desc', $article->sub_desc ? $article->sub_desc : 'Detail Artikle', $article->title)
