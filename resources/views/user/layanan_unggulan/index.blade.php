...
@section('seo_keyword', 'layanan unggulan, rumah sakit, rumah sakit umum daerah cimacan, rsud cimacan, rsd cimacan')
@section('seo_title', 'Layanan Unggulan | RSD Cimacan')
@section('seo_desc',
    'Layanan unggulan RSUD Cimacan terdiri dari ODASOR atau Obat Datang Sorangan yang menjadi salah satu layanan unggu...')
@section('seo_url', route('user.layanan_unggulan.index'))
...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <span><small><a href="">Beranda</a> / <a href="">Services</a> / <strong>Layanan Unggulan</strong></small></span>
                <div class="text-center">
                    <img style="height: 250px; width: 100%; object-fit:cover;" src="{{ asset('storage/'. $unggulan->banner) }}" alt="">
                </div>
            </div>
