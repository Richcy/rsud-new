...
@section('seo_desc', 'Daftar Kariryang diterbitkan oleh Rumah Sakit Daerah Cimacan')
@section('seo_url', route('user.career.index'))
...
<div class="container my-4">
    <div class="row">
        <span><small><a href="">Beranda</a> / <strong>Karir</strong></small></span>
        <div class="col-xl-12 mt-5 pt-5 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
            <div class="rr-price-2-title-box text-center mb-45">
               <h4 class="rr-section-title rr-section-title-space">Karir</h4>
            </div>
         </div>
            ...
            <div class="row container">
              <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Filter Karir</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('user.career.index') }}" method="GET">
                        <div class="row">
                            <div class="col-12">
                                <label for="title" class="form-label">Judul Karir</label>
                                <input type="title" type="text" name="title" class="form-control" placeholder="Judul Karir" id="title" value="{{ request('title') }}">
                        ...
                        <div class="d-flex justify-content-end my-1 mt-3">
                            <button type="reset" class="btn btn-secondary me-1" onclick="window.location='{{ route('user.career.index') }}'">Reset</button>
                ...
                @forelse ($careers as $item)
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30 wow rrfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                        ...
                        <div class="rr-blog-thumb-main p-relative">
                            <a href="{{ asset('storage/'. $item->image) }}" data-glightbox="title: {{ $item->title }}">
                        ...
                        <div class="rr-blog-content rr-blog-content-opcity p-relative">
                            ...
                            <div class="rr-blog-wrap d-flex align-items-center justify-content-between">
                                ...
                                <div class="rr-blog-link">
                                    <a href="{{ route('user.career.show', $item->slug) }}">Lihat Selengkapnya <i class="fa-light fa-angle-right"></i></a>
                                </div>
