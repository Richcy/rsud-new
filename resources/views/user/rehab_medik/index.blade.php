...
@section('content')
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <span><small><a href="">Beranda</a> / <a href="">Services</a> / <strong>Rehabilitasi Medik</strong></small></span>
                <div class="text-center">
                    <img style="height: 250px; width: 100%; object-fit:cover;" src="{{ asset('storage/'. $rehab_medik->banner) }}" alt="">
                </div>
            </div>

            <div class="col-12 my-4">
                <div class="text-left">
                    <h3>REHABILITAS MEDIK</h3>
                </div>
                <div class="row">
                    <div class="{{ $image->isNotEmpty() ? 'col-12 col-md-6 col-lg-8' : 'col-12' }}">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse{{ $loop->index }}" class="accordion-collapse collapse" aria-rehab_medikelledby="heading{{ $loop->index }}" data-bs-parent="#accordionExample">
