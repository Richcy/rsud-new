            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Form Edit Kategori Acara</h2>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" laceholder="Masukan Nama Kategori Acara" value="{{ old('name', $categoryEvent->name) }}">
