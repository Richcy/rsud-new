                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="#">Daftar Kategori Acara</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            {{-- button tambah --}}
                            <a href="{{ route('admin.category-event.create') }}" class="btn btn-primary">Tambah Kategori Acara</a>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    id="datatable-category-event">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Kategori</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-category-event').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
        ...
        $('#datatable-category-event').on('click', '.btn-delete', function() {
                ...
                swal({
                    ...
                    text: "Kategori Acara akan dihapus!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                swal("Kategori Acara berhasil dihapus!", {
                                    icon: "success",
                                });

                                // Muat ulang tabel setelah penghapusan
                                $('#datatable-category-event').DataTable().ajax.reload();
                            },
