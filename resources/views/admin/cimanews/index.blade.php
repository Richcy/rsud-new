                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2>Cimanews</h2>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.cimanews.create') }}" class="btn btn-primary">Tambah Cimanews</a>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    id="datatable-cimanews">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Judul</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-cimanews').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "/administrator/cimanews",
                type: 'GET',
                headers: {
        ...
        $('#datatable-cimanews').on('click', '.btn-delete', function() {
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                swal("Cimanews berhasil dihapus!", {
                                    icon: "success",
                                });

                                // Muat ulang tabel setelah penghapusan
                                $('#datatable-cimanews').DataTable().ajax.reload();
                            },
