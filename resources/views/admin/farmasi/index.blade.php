                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.farmasi.sub-service.index', $data->id) }}">Sub Service</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.farmasi.gallery.index') }}">Galeri</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    @if ($data != null)
                               <form action="{{ route('admin.farmasi.update', $data->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                @endif
                                    <div class="col-12">
