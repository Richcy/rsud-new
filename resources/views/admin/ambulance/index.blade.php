    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h4 class="content-header-title float-start mb-0">Data Ambulans</h4>
                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.ambulance.sub-service.index', $data->id) }}">Sub Service</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.ambulance.gallery.index') }}">Galeri</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    @if ($data != null)
                               <form action="{{ route('admin.ambulance.update', $data->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                @endif
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    <label for="description" class="form-label">Deskripsi Ambulans</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    <label for="img" class="form-label">Foto Banner Ambulans</label>
