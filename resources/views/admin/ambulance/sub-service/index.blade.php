                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link"  href="{{ route('admin.ambulance.index') }}">Deskripsi</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-header">
                            <h4>Sub Service</h4>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.ambulance.sub-service.create', $id) }}" class="btn btn-primary">Tambah Sub Service</a>
                        </div>
                        <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-sub-service').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '/administrator/ambulance/sub-service/{{ $id }}',
                type: 'GET',
                headers: {
