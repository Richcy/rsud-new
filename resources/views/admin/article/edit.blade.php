                        ...
                        <form action="{{ route('admin.article.update', $article->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title" onkeyup="createSlug()" placeholder="Masukan Nama Judul" value="{{ old('title', $article->title) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="slug" class="form-control @error('slug') is-invalid @enderror" name="slug"  placeholder="Slug akan otomatis di isi sesuai dengan judul" value="{{ old('slug', $article->slug) }}" readonly>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select name="article_category_id"
                                            ...
                                            @foreach ($categoryArticle as $item)
                                                <option value="{{ $item->id }}" @selected(old('article_category_id', $article->article_category_id) == $item->id)>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" id="author" class="form-control @error('author') is-invalid @enderror" name="author" placeholder="Masukan Nama Author" value="{{ old('author', $article->author) }}">
                                        @error('author')
                                            <div class="invalid-feedback d-block">{{ $message ?? 'Something error' }}
                                            </div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <div id="avatar-content">
                                            @if($article->img)
                                                <img src="{{ asset('storage/' . $article->img) }}" id="avatar-image" style="width: 200px;">
                                            @else
                                                -
                                            @endif
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-1">
                                    ...
                                    <textarea name="sub_desc" id="sub_desc" cols="5" rows="2" class="form-control">{{ old('sub_desc', $article->sub_desc) }}</textarea>
                                    @error('sub_desc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-1">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="50" class="form-control tinymce">{{ old('description', $article->description) }}</textarea>
                                    @error('description')
