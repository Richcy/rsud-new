                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body" style="padding-top: 6px !important;">
                            <form action="{{ route('admin.layanan-unggulan-sub-service.update', $subService->slug) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    <a href="{{ route('admin.layanan-unggulan-sub-service.index', $subService->service_id) }}"
