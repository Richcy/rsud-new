                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.radiology.gallery.index') }}">Daftar Gambar Layanan Unggulan</a>
                            </li>
                            <li class="breadcrumb-item active">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="padding-top: 6px !important;">
                        <form action="{{ route('admin.radiology.gallery.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                <a href="{{ route('admin.radiology.gallery.index') }}"
