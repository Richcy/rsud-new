            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="padding-top: 6px !important;">
                        <form action="{{ route('admin.gawat-darurat.sub-service.store', $id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                <a href="{{ route('admin.gawat-darurat.sub-service.index', $id) }}"
