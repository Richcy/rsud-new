                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"  href="{{ route('admin.gawat-darurat.sub-service.index', $id) }}">Sub Service</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-header">
                            <h4>Galeri</h4>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.gawat-darurat.gallery.create') }}" class="btn btn-primary">Tambah Galeri</a>
                        </div>
                        <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-gallery').DataTable({
            ...
            responsive: true,
            ajax: {
                url: '/administrator/gawat-darurat/gallery',
                type: 'GET',
                headers: {
