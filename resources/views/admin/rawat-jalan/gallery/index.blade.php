                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"  href="{{ route('admin.rawat-jalan.sub-service.index', $id) }}">Sub Service</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-header">
                            <h4>Galeri</h4>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.rawat-jalan.gallery.create') }}" class="btn btn-primary">Tambah Galeri</a>
                        </div>
                        <div class="card-body">
