    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Data Profil Galeri</h2>
                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <ul class="nav nav-pills card-header-pills ms-0" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.profile.index') }}">Deskripsi</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-header">
                            <h4>Tentang Rumah Sakit Galeri</h4>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.profileGallery.create') }}" class="btn btn-primary">Tambah Galeri</a>
                        </div>
                        <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-profile-gallery').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            ajax: {
        ...
        $('#datatable-profile-gallery').on('click', '.btn-delete', function() {
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#datatable-profile-gallery').DataTable().ajax.reload();
                            },
