            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="padding-top: 6px !important;">
                        <form action="{{ route('admin.field-doctor.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        <label for="name" class="form-label">Nama Bidang Dokter</label>
                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Masukan Nama Bidang Dokter" value="{{ old('name') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="lang" class="form-control @error('lang') is-invalid @enderror" name="lang" placeholder="Contoh Indonesia, Inggris" value="{{ old('lang') }}">
                                        @error('lang')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
