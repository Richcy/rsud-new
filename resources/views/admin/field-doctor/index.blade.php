                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2>Bidang Dokter</h2>
                            {{-- button tambah --}}
                            <a href="{{ route('admin.field-doctor.create') }}" class="btn btn-primary">Tambah Bidang Dokter</a>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <table class="datatables-basic table dataTable no-footer dtr-column"
                                    id="datatable-field-doctor">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Kategori</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable-field-doctor').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "/administrator/field-doctor",
                type: 'GET',
                headers: {
        ...
        $('#datatable-field-doctor').on('click', '.btn-delete', function() {
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#datatable-field-doctor').DataTable().ajax.reload();
                            },
