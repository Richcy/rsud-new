                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" onkeyup="createSlug()" placeholder="Masukan Nama Dokter" value="{{ old('name') }}">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select name="field_id" id="field_id"
                                            ...
                                            @foreach ($field as $item)
                                                <option value="{{ $item->id }}" @selected(old('field_id') == $item->id)>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="office" class="form-control @error('office') is-invalid @enderror" name="office" placeholder="Masukan Kantor/Unit Kerja" value="{{ old('office') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="sip" class="form-control @error('sip') is-invalid @enderror" name="sip" placeholder="Masukan SIP Dokter" value="{{ old('sip') }}">
