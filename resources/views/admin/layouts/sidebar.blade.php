        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="bi bi-briefcase" style="padding-top: 0; margin-top: -15px;"></i><span class="menu-title text-truncate" data-i18n="Invoice">Pelayanan</span></a>
                <ul class="menu-content">
                    ...
                    <li class="{{ request()->routeIs(['admin.ambulance.*']) ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('admin.ambulance.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Ambulans</span></a>
                    </li>
                </ul>
            </li>
