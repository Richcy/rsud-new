                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title" onkeyup="createSlug()" placeholder="Masukan Nama Diskon" value="{{ old('title', $slider->title) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="slug" class="form-control @error('slug') is-invalid @enderror" name="slug" placeholder="Slug akan otomatis di isi sesuai dengan judul" value="{{ old('slug', $slider->slug) }}" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            <div id="avatar-content">
                                                @if($slider->img)
                                                    <img src="{{ asset('storage/' . $slider->img) }}" id="avatar-image" style="width: 200px;">
                                                @else
                                                    -
                                                @endif
                                            </div>
